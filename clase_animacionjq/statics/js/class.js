  ...
  class Credito {
      ...
      mensajeFinal(importeFinal) {
          ...
          detalle.innerHTML = "Hola " + this.usuario.nombre + "" + this.usuario.apellido + " DNI: " + this.usuario.DNI + " podemos otorgarte hasta: $" + importeFinal + " o en dolares: " + importeFinal / parseFloat(this.valorDolar);
      ...
      calcularDolar() {
          ...
          $.ajax({
              ...
              success: function (result) {
                  console.log(result);
                  let montoMaximoAPrestar = self.montoMaximoAPrestar();
                  self.valorDolar = result[0].casa.venta;
                  self.mensajeFinal(montoMaximoAPrestar);
              }
          });
      }
